...
**[Самостоятельный хостинг n8n с SSL на Linux-сервере](n8n_hosting_guide_ru.md)** — полное развёртывание с нуля: Docker, запуск n8n в контейнере, Nginx как обратный прокси, бесплатный SSL от Let's Encrypt, брандмауэр, обновление и резервное копирование.
